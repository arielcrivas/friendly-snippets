...
> [!INFORMATION]
> This repository is a fork of [friendly-snippets](https://github.com/rafamadriz/friendly-snippets)
...
> {
>   "L3MON4D3/LuaSnip",
>   dependencies = { "arielcrivas/friendly-snippets" },
> }
> ```
...
```lua
use "arielcrivas/friendly-snippets"
```

### With vim-plug

```vim
Plug "arielcrivas/friendly-snippets"
```

### With coc.nvim

```vim
:CocInstall https://github.com/arielcrivas/friendly-snippets@main
```
...
[`snippets/frameworks`](https://github.com/arielcrivas/friendly-snippets/tree/main/snippets/frameworks)
